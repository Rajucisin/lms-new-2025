        ...
        <div className='container'>
            ...
            <div className='setting-card mb-32'>
                ...
                <div className='setting-card-bg'>
                    ...
                    <Link href="/dashboard/changepassword" className='setting-item d-flex align-items-center'>
                        <div className='me-auto'>
                    ...
                    <Link href="/dashboard/needbreak" className='setting-item d-flex align-items-center'>
                        <div className='me-auto'>
                    ...
                    <div className='setting-item d-flex align-items-center deactivate-account'>
                        ...
                        <div className='ml-auto'>
                            <Link href="/dashboard/deactivateaccount">
