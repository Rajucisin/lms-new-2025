                ...
                <div className='d-flex align-items-center'>
                    ...
                    <div className='header-right'>
                        <ul className='d-flex align-items-center justify-content-center'>
                            <li><Link href="/dashboard/helpandsupport">Help & Support</Link></li>
                            <li><Link href="/dashboard/contactus">Contact Us</Link></li>
                            <li><Link href="/dashboard/termsandcondition">Terms of Use</Link></li>
                            <li><Link href="/dashboard/privacypolicy">Privacy Policy</Link></li>
                        </ul>
                    </div>
