        ...
        <div className='sec-how-it-work sec-gap bg-darker col-gap'>
            <div className='container max-container'>
                ...
                <div className='page-header'>
                    ...
                    <p>Welcome to the LMS Punters Club. The rules are simple, but survival is hard. Understand the mechanics, plan your strategy, and don’t get eliminated</p>
                </div>
                <div className='row'>
                    <div className='col-lg-4'>
                        <div className="step-card">
                            ...
                            <ul className='list-bullet mb-24'>
                                ...
                                <li>Not available to residents of South Australia</li>
                            </ul>
                    ...
                    <div className='col-lg-4'>
                        <div className="step-card">
                            ...
                            <ul className='list-bullet mb-24'>
                                <li>Shared equally if multiple players survive the final round.</li>
                                <li>Prize funds held in a dedicated customer funds account.</li>
                            </ul>
                        </div>
                    </div>
                    <div className='col-lg-4'>
